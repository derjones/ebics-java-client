...
import org.ebics.s002.SignaturePubKeyOrderDataDocument;
...
import org.kopi.ebics.schema.h005.TransactionPhaseType;
...
public final class EbicsXmlFactory {
    ...
    public static SignedInfoType createSignedInfoType(
        CanonicalizationMethodType canonicalizationMethod, SignatureMethodType signatureMethod,
     ...
     */
    public static ReferenceType createReferenceType(String uri, TransformsType transforms,
        DigestMethodType digestMethod, byte[] digestValue) {
    ...
    public static OrderSignatureDataType createOrderSignatureDataType(String signatureVersion,
        String partnerID, String userID, byte[] signatureValue) {
    ...
    public static EbicsUnsecuredRequestDocument createEbicsUnsecuredRequestDocument(
        EbicsUnsecuredRequestDocument.EbicsUnsecuredRequest ebicsUnsecuredRequest) {
     ...
     */
    public static EbicsUnsecuredRequestDocument.EbicsUnsecuredRequest createEbicsUnsecuredRequest(
        EbicsUnsecuredRequestDocument.EbicsUnsecuredRequest.Header header,
        EbicsUnsecuredRequestDocument.EbicsUnsecuredRequest.Body body, int revision,
        String version) {
     ...
     */
    public static Header createHeader(boolean authenticate, EmptyMutableHeaderType mutable,
    ...
    public static UnsecuredRequestStaticHeaderType createUnsecuredRequestStaticHeaderType(
        String hostId, String partnerId, String userId, ProductElementType product,
        OrderDetailsType orderDetails, String securityMedium) {
    ...
    public static OrderDetailsType createOrderDetailsType(String orderType) {
        OrderDetailsType newOrderDetailsType = OrderDetailsType.Factory.newInstance();
        newOrderDetailsType.setAdminOrderType(orderType);
    ...
    public static HIARequestOrderDataType createHIARequestOrderDataType(
        ...
        EncryptionPubKeyInfoType encryptionPubKeyInfo, String partnerId, String userId) {
     ...
     * //@param pubKeyValue           the <code>PubKeyValueType</code> element
     * @param x509Data              the <code>X509DataType</code> element
    ...
    public static AuthenticationPubKeyInfoType createAuthenticationPubKeyInfoType(
        String authenticationVersion, X509DataType x509Data) {
        AuthenticationPubKeyInfoType type = AuthenticationPubKeyInfoType.Factory.newInstance();
        type.setAuthenticationVersion(authenticationVersion);
        type.setX509Data(x509Data);
        return type;
    }
     ...
     * @param header   the <code>EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Header</code> element
     * @param body     the <code>EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Body</code> element
    ...
    /**
     * Creates a new <code>EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Header</code> XML object
     *
     * @param authenticate should authenticate?
     * @param mutable      the <code>EmptyMutableHeaderType</code> element
     * @param xstatic      the <code>NoPubKeyDigestsRequestStaticHeaderType</code> element
     * @return the <code>EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Header</code> XML object
     */
    public static EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Header createDigestsRequestHeader(
        boolean authenticate, EmptyMutableHeaderType mutable,
    ...
    public static NoPubKeyDigestsRequestStaticHeaderType createNoPubKeyDigestsRequestStaticHeaderType(
        String hostId, byte[] nonce, Calendar timestamp, String partnerId, String userId,
        ProductElementType product, OrderDetailsType orderDetails, String securityMedium) {
    ...
    /**
     * Creates a new <code>EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Body</code> XML object
     *
    ...
    public static EbicsNoPubKeyDigestsRequestDocument createEbicsNoPubKeyDigestsRequestDocument(
        EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest ebicsNoPubKeyDigestsRequest) {
     ...
     * @param revision the default revision
     * @param version  the default version
     * @param header   the <code>EbicsRequestDocument.EbicsRequest.Header</code> element
     * @param body     the <code>EbicsRequestDocument.EbicsRequest.Body</code> element
     * @return the <code>EbicsRequest</code> XML object
     */
    public static EbicsRequest createEbicsRequest(int revision, String version,
    ...
    /**
     * Creates a new <code>EbicsRequestDocument.EbicsRequest.Header</code> XML object
     *
     * @param authenticate should authenticate?
     * @param mutable      the <code>MutableHeaderType</code> element
     * @param xstatic      the <code>StaticHeaderType</code> element
     * @return the <code>EbicsRequestDocument.EbicsRequest.Header</code> XML object
     */
    public static EbicsRequestDocument.EbicsRequest.Header createEbicsRequestHeader(
     ...
     */
    public static MutableHeaderType createMutableHeaderType(String transactionPhase,
        SegmentNumber segmentNumber) {
        MutableHeaderType newMutableHeaderType = MutableHeaderType.Factory.newInstance();
        newMutableHeaderType.setTransactionPhase(
            TransactionPhaseType.Enum.forString(transactionPhase));
     ...
     */
    public static StaticHeaderType createStaticHeaderType(String hostId, byte[] nonce,
     ...
     */
    public static StaticHeaderType createStaticHeaderType(String hostId, byte[] nonce,
        String partnerId, StaticHeaderType.Product product, String securityMedium, String userId,
        Calendar timestamp, StaticHeaderOrderDetailsType orderDetails,
        StaticHeaderType.BankPubKeyDigests bankPubKeyDigests) {
...
//        OrderAttributeType.Enum orderAttribute, OrderType orderType,
...
//    }
     ...
     */
    public static BankPubKeyDigests createBankPubKeyDigests(Authentication authentication,
     ...
     */
    public static Authentication createAuthentication(String version, String algorithm,
        byte[] value) {
    ...
    /**
     * Create the <code>EbicsRequestDocument.EbicsRequest.Body</code> XML object
     *
     ...
     * Create the <code>DataTransferRequestType</code> XML object
     *
     * @param orderData the <code>DataTransferRequestType.OrderData</code> element
     * @return the <code>DataTransferRequestType</code> XML object
     */
    public static DataTransferRequestType createDataTransferRequestType(
    ...
    /**
     * Create the <code>DataTransferRequestType.OrderData</code> XML object
     *
     * @param orderDataValue the order data value
     * @return the <code>DataTransferRequestType.OrderData</code> XML object
     */
    public static DataTransferRequestType.OrderData createTransferRequestTypeOrderData(
        byte[] orderDataValue) {
    ...
    public static DataEncryptionInfo createDataEncryptionInfo(boolean authenticate,
        EncryptionPubKeyDigest encryptionPubKeyDigest, byte[] transactionKey) {
     ...
     */
    public static EncryptionPubKeyDigest createEncryptionPubKeyDigest(String version,
        String algorithm, byte[] value) {
     ...
     * @return the the <code>DataTransferRequestType.OrderData</code> XML object
     */
    ...
    public static XmlObject qualifySubstitutionGroup(XmlObject xobj, QName newInstance,
        ...
        if (newType != null) {
            ...
            if (substitute != null && substitute.schemaType() == newType && substitute.getDomNode()
                .getLocalName().equals(newInstance.getLocalPart())) {
                return substitute;
            }
        }
    ...
    public static KeyValueType createKeyValueType(RSAKeyValueType encryptionRsaKeyValue) {
        var keyValue = KeyValueType.Factory.newInstance();
        keyValue.setRSAKeyValue(encryptionRsaKeyValue);
        return keyValue;
    }

    public static PubKeyInfoType createPubKeyInfoType(X509DataType encryptionX509Data) {
        var pubKeyInfo = PubKeyInfoType.Factory.newInstance();
    ...
    public static EncryptionPubKeyInfoType createEncryptionPubKeyInfoType(String encryptionVersion,
        ...
        var pubKeyInfo = EncryptionPubKeyInfoType.Factory.newInstance();
        pubKeyInfo.setEncryptionVersion(encryptionVersion);
        pubKeyInfo.setX509Data(encryptionX509Data);
        return pubKeyInfo;
    }
